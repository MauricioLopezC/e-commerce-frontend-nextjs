  ...
  return (
    <Card x-chunk="dashboard-07-chunk-1">
      <CardHeader>
        ...
        <CardDescription>Editar las variaciones del producto</CardDescription>
      </CardHeader>
      <CardContent>
        <Table>
          <TableHeader>
          ...
          <TableBody>
            {productSkus.map((productSku, idx) => (
              <TableRow key={idx}>
                <TableCell className="font-semibold">{productSku.id}</TableCell>
                <TableCell>{productSku.quantity}</TableCell>
                <TableCell>{productSku.color}</TableCell>
                <TableCell>{productSku.size}</TableCell>
                <TableCell>
      ...
      <CardFooter className="justify-center border-t p-4">
        ...
        {PSkuIdToDelete && ( //if not null
          <DeleteAlert
            productId={productSkus[0].productId}
            productSkuId={PSkuIdToDelete}
