          ...
          <TableBody>
            {users.map((user, idx) => (
              <TableRow key={idx}>
                ...
                <TableCell className="hidden md:table-cell">
                  {!user.isBanned && <Badge variant="outline">Activo</Badge>}
                  {user.isBanned && (
              ...
              <AlertDialogHeader>
                <AlertDialogTitle>
                  {confirmData.action === 'delete' &&
                    `Eliminar ${confirmData.user.firstName} ${confirmData.user.lastName}`}
                  {confirmData.action === 'block' &&
                    `Bloquear ${confirmData.user.firstName} ${confirmData.user.lastName}`}
                  {confirmData.action === 'unblock' &&
                    `Desbloquear ${confirmData.user.firstName} ${confirmData.user.lastName}`}
                </AlertDialogTitle>
                <AlertDialogDescription>
                  {confirmData.action === 'delete' &&
                  ...
                  {confirmData.action === 'unblock' &&
                    'El usuario podrá volver a usar su cuenta.'}
                </AlertDialogDescription>
              </AlertDialogHeader>
              <AlertDialogFooter>
